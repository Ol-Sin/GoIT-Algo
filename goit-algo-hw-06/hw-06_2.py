...
for path in dfs_paths:
    print(" -> ".join(cities[node] for node in path))
...
print(f"Кількість шляхів, знайдених за допомогою DFS: {len(dfs_paths)}")
print(f"Кількість шляхів, знайдених за допомогою BFS: {len(bfs_paths)}")

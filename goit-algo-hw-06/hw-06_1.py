...
cities = [
    "Вінниця", "Дніпропетровськ", "Донецьк", "Житомир", "Запоріжжя", 
...
# Знаходимо вершини з найбільшим та найменшим ступенем
max_degree_node = max(degrees, key=degrees.get)
min_degree_node = min(degrees, key=degrees.get)
print(f"Вершина з найбільшим ступенем: {G.nodes[max_degree_node]['label']}, ступінь: {degrees[max_degree_node]}")
print(f"Вершина з найменшим ступенем: {G.nodes[min_degree_node]['label']}, ступінь: {degrees[min_degree_node]}")
